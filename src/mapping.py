...
This link will directly download the zipped folder to your computer. The needed shape file is inside.
...
counties = gpd.read_file("data/cb_2018_us_county_500k.shp")
...
'''
Originally created this dataframe from it is is included in the intial steps of the make data command:
